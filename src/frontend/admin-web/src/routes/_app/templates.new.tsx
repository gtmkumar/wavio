...
function NewTemplatePage() {
  ...
  return (
    <>
      <PageHeader
        title="New template"
        description="Templates are created as drafts, compiled to Meta's component format, and submitted for review."
      />
      <form onSubmit={onSubmit} noValidate>
        <Card className="max-w-2xl">
          <CardHeader>
            ...
            <CardDescription>
              Name must be lowercase snake_case; body text supports {"{{1}}"} placeholders.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              <Button variant="ghost" onClick={() => void navigate({ to: "/templates" })}>
                Cancel
              </Button>
              <Button
                type="submit"
