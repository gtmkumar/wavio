...
/// reconnecting on demand when the cached connection has dropped. Same pattern as
/// WaIngest.Infrastructure's connection manager of the same name — each service owns its own
/// copy rather than sharing a cross-service project reference.
/// </summary>
