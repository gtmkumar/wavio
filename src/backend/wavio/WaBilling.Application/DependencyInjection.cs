...
namespace WaBilling.Application;

/// <summary>
/// DI registration for the wa-billing-svc Application layer. Registers the custom CQRS dispatcher +
...
{
    public static IServiceCollection AddWaBillingApplication(this IServiceCollection services)
    {
