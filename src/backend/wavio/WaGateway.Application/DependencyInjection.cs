...
namespace WaGateway.Application;

/// <summary>
/// DI registration for the wa-gateway-svc Application layer. Registers the custom CQRS dispatcher +
...
{
    public static IServiceCollection AddWaGatewayApplication(this IServiceCollection services)
    {
